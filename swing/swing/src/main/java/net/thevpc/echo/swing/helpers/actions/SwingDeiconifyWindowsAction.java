 ...
 * @author thevpc
 */
public class SwingDeiconifyWindowsAction extends SwingAbstractAppAction {
    private InternalWindowsHelper wins;
    public SwingDeiconifyWindowsAction(Application aplctn, InternalWindowsHelper wins) {
