...
//    public FxAppPopupMenu(AppContainerModel folder, Application application, AppComponentOptions options) {
//        super(folder, new ContextMenu(), application, options);
//    }
//
//    public FxAppPopupMenu(AppContainerModel folder, ContextMenu button, Application application, AppComponentOptions options) {
