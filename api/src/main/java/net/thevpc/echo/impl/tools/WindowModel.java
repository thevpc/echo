 ...
 * @author thevpc
 */
public class WindowModel extends ContainerModel implements AppWindowModel {
    ...
    protected WritableValue<AppWindowAnchor> anchor = Props.of("anchor").valueOf(AppWindowAnchor.class, AppWindowAnchor.CENTER);
    ...
    public WindowModel(String id, Str title, AppWindowAnchor anchor, AppComponent component, Application app) {
        super(id,app);
        title().set(title);
        this.app = app;
