...
// * @author vpc
// */
//public interface AppToolBuilder {
//
//    AppToolBuilder id(String id);
//
//    AppToolBuilder options(AppComponentOptions options);
//
//    AppToolBuilder order(Integer id);
//
//    AppToolBuilder componentType(AppComponentType componentType);
//
...
//
//    public List<? extends AppComponent> components();
//
//}
