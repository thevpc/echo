...
public class StarsField<T extends Number> extends NumberBase<T> implements AppNumberField<T>, AppContentAdapter {
    ...
    private WritableValue<StarFieldRenderer<T>> renderer;
    ...
    public WritableValue<StarFieldRenderer<T>> renderer() {
        return renderer;
    }
    ...
    private void revalidateValue() {
        ...
        StarFieldRenderer<T> starRenderer = renderer().get();
    ...
    private class NumberStarRendererContext implements StarFieldRendererContext<T> {
