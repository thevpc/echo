...
import net.thevpc.echo.api.AppBorder;
...
public class ComponentBase extends PropertyBase implements AppComponent {
    ...
    private final WritableValue<AppBorder> border = Props.of("border").valueOf(AppBorder.class);
    ...
    public ComponentBase(String id, Application app,
        ...
        propagateEvents(anchor, enabled, visible, editable, active, title, titleStyle,
                ...
                contextMenu, parentConstraints, childConstraints, order, border
        );
    ...
    @Override
    public WritableValue<AppBorder> border() {
        return border;
    }
    ...
    public void updateUI() {
        ((DefaultPropertyListeners) events()).firePropertyUpdated(
                new PropertyEvent(
                        ...
                        PropertyUpdate.REFRESH, "UpdateUI", true
                )
        );
    }
}
